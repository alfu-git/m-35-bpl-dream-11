...
const Banner = () => {
  return (
    ...
    >
      ...
      <h1 className='mb-4 text-base-100 text-[40px] font-bold text-center'>Assemble Your Ultimate Dream 11 Cricket Team</h1>
      <p className='mb-6 text-base-100 text-2xl font-light text-center'>Beyond Boundaries Beyond Limits</p>
